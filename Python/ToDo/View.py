...
class ToDoView:
    def __init__(self):
        ...
        self.button1 = tk.Button(self.okvir_gumbov, text="Dodaj", width=10)
        self.button1.pack(side=tk.LEFT, padx=5)
        self.button2 = tk.Button(self.okvir_gumbov, text="Delete",  width=10)
        self.button2.pack(side=tk.LEFT, padx=5)
        self.button3 = tk.Button(self.okvir_gumbov, text="Done",  width=10)
